...
class DMDFrame
{
 ...
 public:
  ...
  void setPixel(unsigned int x, unsigned int y, DMDGraphicsMode mode=GRAPHICS_OFF);
  ...
  void drawFilledBox(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2, DMDGraphicsMode mode=GRAPHICS_OFF
    );
